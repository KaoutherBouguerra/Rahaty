...
import art4muslim.macbook.rahatycustomer.fragments.SearchFragment;
...
public class DoneOrderFragment extends Fragment
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.action_user).setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
