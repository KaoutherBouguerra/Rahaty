...
public class AboutUsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (app.getSettingsModel()==null)
            ...
            if (!isRightToLeft ) {
                _txt_about.setText(Html.fromHtml(app.getSettingsModel().getEn_about_us()));
            }else    _txt_about.setText(Html.fromHtml(app.getSettingsModel().getAr_about_us()));
        }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status.equals("1")){
                        ...
                        _txt_about.setText(Html.fromHtml(ar_about_us));
